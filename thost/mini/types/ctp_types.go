...
func (t TThostFtdcLowerLimitType) String() string { return DecodeGBK(t[:]) }
...
func (t TThostFtdcClientAppIDType) String() string { return DecodeGBK(t[:]) }
...
func (t TThostFtdcAddressAndPortType) String() string { return DecodeGBK(t[:]) }
...
func (t TThostFtdcAutoCodeType) String() string { return DecodeGBK(t[:]) }
...
func (t TThostFtdcUpperLimitType) String() string { return DecodeGBK(t[:]) }
...
func (t TThostFtdcControlParamValueType) String() string { return DecodeGBK(t[:]) }
...
func (t TThostFtdcOrderFlagType) String() string { return DecodeGBK(t[:]) }
