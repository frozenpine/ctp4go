...
func (i TThostFtdcSyncDataStatusType) String() string {
	idx := int(i) - 48
	if i < 48 || idx >= len(_TThostFtdcSyncDataStatusType_index)-1 {
		return "TThostFtdcSyncDataStatusType(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _TThostFtdcSyncDataStatusType_name[_TThostFtdcSyncDataStatusType_index[idx]:_TThostFtdcSyncDataStatusType_index[idx+1]]
}
