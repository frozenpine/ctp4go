...
type TraderApi interface {
	...
	GetFrontInfo(pFrontInfo *CThostFtdcFrontInfoField)

	/// 注册前置机网络地址
	///@param pszFrontAddress：前置机网络地址。
	///@remark 网络地址的格式为：“protocol://ipaddress:port”，如：”tcp://127.0.0.1:17001”。
	///@remark “tcp”代表传输协议，“127.0.0.1”代表服务器地址。”17001”代表服务器端口号。
	RegisterFront(pszFrontAddress string)
	...
	RegisterNameServer(pszNsAddress string)
	...
	/// 请求查询交易员报盘机
	ReqQryTraderOffer(pQryTraderOffer *CThostFtdcQryTraderOfferField, nRequestID int) int
