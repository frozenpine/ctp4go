...
typedef void (*SubscribePrivateTopic)(void *this, int nResumeType, int nSeqNo);
...
typedef void* (*CreateFtdcTraderApi)(char* pszFlowPath, bool bIsProductionMode);
void* CallCreateFtdcTraderApi(CreateFtdcTraderApi fn, char* pszFlowPath, bool bIsProductionMode);
...
void CallSubscribePrivateTopic(SubscribePrivateTopic fn, void *this, int nResumeType, int nSeqNo);
