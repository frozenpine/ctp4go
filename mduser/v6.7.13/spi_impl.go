...
func CgoOnRspQryMulticastInstrument(
	...
	(*ThostFtdcMdSpi)(
		...
		(*thost.CThostFtdcMulticastInstrumentField)(unsafe.Pointer(pMulticastInstrument)),
		(*thost.CThostFtdcRspInfoField)(unsafe.Pointer(pRspInfo)),
		int(nRequestID),
		bool(bIsLast),
	)
...
func CgoOnRspSubMarketData(
	...
	(*ThostFtdcMdSpi)(
		...
		(*thost.CThostFtdcSpecificInstrumentField)(unsafe.Pointer(pSpecificInstrument)),
		(*thost.CThostFtdcRspInfoField)(unsafe.Pointer(pRspInfo)),
		int(nRequestID),
		bool(bIsLast),
	)
