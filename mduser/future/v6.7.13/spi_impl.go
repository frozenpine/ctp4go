...
func init() {
	...
	spiCVtablePtr.CThostFtdcMdSpiVTable_OnRspQryMulticastInstrument = (C.OnRspQryMulticastInstrument)(
...
func CgoOnRspQryMulticastInstrument(
	...
	(*ThostFtdcMdSpi)(
		...
		(*future.CThostFtdcMulticastInstrumentField)(unsafe.Pointer(pMulticastInstrument)),
		(*future.CThostFtdcRspInfoField)(unsafe.Pointer(pRspInfo)),
		int(nRequestID),
		bool(bIsLast),
	)
...
func CgoOnRspSubMarketData(
	...
	(*ThostFtdcMdSpi)(
		...
		(*future.CThostFtdcSpecificInstrumentField)(unsafe.Pointer(pSpecificInstrument)),
		(*future.CThostFtdcRspInfoField)(unsafe.Pointer(pRspInfo)),
		int(nRequestID),
		bool(bIsLast),
	)
