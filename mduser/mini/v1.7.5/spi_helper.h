#pragma once
#ifndef MDUSER_V175_SPI_HELPER_H
#define MDUSER_V175_SPI_HELPER_H
...
// converted from ..\dependencies\mini\v1.7.5\ThostFtdcMdApi.h
// function call ptr
...
typedef void (*OnRtnMBLMarketData)(void *this, struct CThostFtdcMBLMarketDataField* pMBLMarketData);
...
void COnRtnMBLMarketData(void *this, struct CThostFtdcMBLMarketDataField* pMBLMarketData);
...
typedef struct
{
    ...
    OnRtnMBLMarketData CThostFtdcMdSpiVTable_OnRtnMBLMarketData;
