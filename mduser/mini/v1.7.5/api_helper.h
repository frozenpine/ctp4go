#pragma once
#ifndef MDUSER_V175_API_HELPER_H
#define MDUSER_V175_API_HELPER_H
...
typedef void (*Init)(void *this, bool bContinuousm);
...
typedef struct
{
    ...
    ReqUserLoginEncrypt CThostFtdcMdApiVTable_ReqUserLoginEncrypt;
