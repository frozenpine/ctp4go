...
func (api *ThostFtdcMdApi) Init(Continuousm bool) {
...
func (api *ThostFtdcMdApi) RegisterSpi(Spi mini.MdSpi) {
...
func (api *ThostFtdcMdApi) ReqUserLogin(ReqUserLoginField *mini.CThostFtdcReqUserLoginField, RequestID int) int {
...
func (api *ThostFtdcMdApi) ReqUserLoginEncrypt(ReqUserLoginField *mini.CThostFtdcReqUserLoginField, RequestID int) int {
	slog.Info("executing thost mduser api ReqUserLoginEncrypt")

	rtn := C.CallReqUserLoginEncrypt(
		api.apiPtr.vtable.CThostFtdcMdApiVTable_ReqUserLoginEncrypt,
		unsafe.Pointer(api.apiPtr),
		(*C.struct_CThostFtdcReqUserLoginField)(unsafe.Pointer(ReqUserLoginField)), C.int(RequestID),
	)

	slog.Info("thost mduser api ReqUserLoginEncrypt executed")

	return int(rtn)
}

func (api *ThostFtdcMdApi) ReqUserLogout(UserLogout *mini.CThostFtdcUserLogoutField, RequestID int) int {
